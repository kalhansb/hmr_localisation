...
PREFIX=/home/jetsondevkit/glim-install
SG=/tmp/claude-1000/-home-jetsondevkit/0e7ee909-3f2f-4b65-85f4-bec3127c6fd2/scratchpad/harness

# No `set -u`: ROS setup.bash reads AMENT_TRACE_SETUP_FILES unguarded.
source /opt/ros/humble/setup.bash
source /home/jetsondevkit/glim_ws/install/setup.bash
export AMENT_PREFIX_PATH=/home/jetsondevkit/ros-extra/prefix/opt/ros/humble:$AMENT_PREFIX_PATH
export LD_LIBRARY_PATH=$PREFIX/lib:/home/jetsondevkit/ros-extra/prefix/opt/ros/humble/lib:/home/jetsondevkit/ros-extra/prefix/opt/ros/humble/lib/aarch64-linux-gnu:$LD_LIBRARY_PATH
...
CFG=/home/jetsondevkit/glim-config/${PROFILE}_${VARIANT}
[ -d "$CFG" ] || { echo "no config at $CFG"; exit 1; }
[ -f "$BAG" ] || { echo "no bag at $BAG"; exit 1; }
OUT=/home/jetsondevkit/glim-output
mkdir -p "$OUT"
...
GLIM_BIN=/home/jetsondevkit/glim_ws/install/glim_ros/lib/glim_ros/glim_rosnode
